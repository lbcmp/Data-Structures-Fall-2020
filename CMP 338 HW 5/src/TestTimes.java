/**You will copy TestTimes.java and the TestTimesInterface,java from Homework 4 to the project you are using for this assignment.*/

/**
 * You will be expanding the functionality of the TestTimes class to implement the expanded TestTimesInterface
 */
